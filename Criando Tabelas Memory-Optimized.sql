...
-- Criando DATABASE MemoryDB
CREATE DATABASE MemoryDB
ON (name = 'MemoryDB', filename = 'C:\MSSQL\Data\MemoryDB.mdf', size = 100MB, filegrowth = 50MB)
LOG ON (name = 'MemoryDB_log', filename = 'C:\MSSQL\Backup_LOG\MemoryDB_log.ldf', size = 50MB, filegrowth = 50MB)
go
...
ALTER DATABASE MemoryDB
ADD FILE (NAME = 'MemoryDB_MemData', FILENAME = 'C:\MSSQL\Data\MemoryDB_Data')
...
SELECT * 
FROM MemoryDB.dbo.Venda_Schema
...
SELECT *
FROM MemoryDB.dbo.Venda_Schema  -- Zero linhas
